...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/status' => [[['_route' => 'app_backend_infrastructure_rafa_number', '_controller' => 'App\\Backend\\Infrastructure\\Controller\\RafaController::number'], null, null, null, true, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_error/(\\d+)(?:\\.([^/]++))?(*:35)'
